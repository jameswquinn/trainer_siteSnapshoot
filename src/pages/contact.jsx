    ...
    return (
      <main class="container">
        ...
        <div style={`width: 100%; height: 100vh; background:
          url('https://api.mapbox.com/styles/v1/mapbox/dark-v10/static/url-https%3A%2F%2Fjameswquinn.github.io%2Fmaps%2FPNG%2Fmarker64.png(${lng},${lat})/${lng},${lat},${zoom}/1000x1000?access_token=pk.eyJ1IjoiamFtZXN3aWxsaWFtcXVpbm4yMDE5IiwiYSI6ImNqeGZhbWk1YjA5aWozb21rcG5wZ25oM2UifQ.5N__EOe9yWAHDaQ6kp9KMg')no-repeat;
